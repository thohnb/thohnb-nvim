...
require("lazy").setup({ { import = "thohnb/plugins" },{import = "thohnb/plugins/git"},{import="thohnb/plugins/lsp"},{import="thohnb/plugins/coding"},{import="thohnb/plugins/debugging"}})
