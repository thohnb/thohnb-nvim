        ...
        hooks = {
          {
            callback = function(dir)
              require("notify")("Switched to dir: " .. dir)
            end,
          },
          {
            callback = function(_)
                vim.cmd([[lua require('telescope').extensions.file_browser.file_browser({ path = '%:p:h', previewer = false, initial_mode = 'normal', layout_config = { height = 20} })]])
